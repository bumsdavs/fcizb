    ...
    <div className="px-[16px]">
      <div className="w-full">
        <div className="text-[14px] w-full font-[500] flex items-center justify-between">
          ...
          <Link href="/dashboard/transactions" className="text-[13px] font-[500] text-[#007255]">
            See All
          </Link>
        </div>
          ...
          {transactionsToShow.map((transaction: Transaction, i) => (
            <div key={i} className="flex justify-between py-3">
              <div className="flex gap-2 text-gray-800">
                <button className="border-none flex items-center justify-center outline-none rounded-full w-[35px] h-[35px] bg-[#007255]/10">
